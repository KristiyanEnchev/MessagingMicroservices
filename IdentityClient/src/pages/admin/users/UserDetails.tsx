...
const UserDetails = () => {
  ...
  // Adding console logging to debug the API call
  ...
  return (
    <div>
      ...
      {/* <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 p-4 mb-6 rounded-md">
        <h3 className="font-medium text-blue-800 dark:text-blue-300 mb-2">Debug Info:</h3>
        <pre className="text-xs bg-white dark:bg-blue-900/30 p-2 rounded overflow-auto max-h-40">
